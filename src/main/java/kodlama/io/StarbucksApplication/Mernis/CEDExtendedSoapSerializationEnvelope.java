...
class CEDSoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class CEDExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(CEDDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new CEDStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static CEDDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static CEDDateTimeConverter dateTimeConverter = new CEDStandardDateTimeConverter();

    public CEDExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public CEDExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new CEDMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=CEDHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,CEDExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=CEDHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
