...
public class CEDKPSPublicSoap12
{
    ...
    public CEDKPSPublicSoap12(){}

    public CEDKPSPublicSoap12(String url)
    {
        this.url = url;
    }

    public CEDKPSPublicSoap12(String url,int timeOut)
    {
        this.url = url;
    ...
    protected CEDExtendedSoapSerializationEnvelope createEnvelope()
    {
        CEDExtendedSoapSerializationEnvelope envelope= new CEDExtendedSoapSerializationEnvelope(CEDExtendedSoapSerializationEnvelope.VER12);
        envelope.enableLogging = enableLogging;
    
        return envelope;
    }

    protected java.util.List sendRequest(String methodName,CEDExtendedSoapSerializationEnvelope envelope,org.ksoap2.transport.Transport transport ,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile )throws java.lang.Exception
    {
    ...
    protected java.lang.Object execute(CEDIWcfMethod wcfMethod,String methodName,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile) throws java.lang.Exception
    {
    ...
    protected java.lang.Exception convertToException(org.ksoap2.SoapFault fault,CEDExtendedSoapSerializationEnvelope envelope)
    {
